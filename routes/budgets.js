...
// GET /api/budgets — all category budgets for current user
...
// POST /api/budgets — create or update (upsert by category)
...
// ── Monthly total cap ──────────────────────────────────────
// NOTE: these /cap routes must come BEFORE /:category to avoid param conflicts
...
// POST /api/budgets/cap — create or update cap
...
// DELETE /api/budgets/cap — remove cap
